...
def sanitize_text(text: str) -> str:
    """Encodes text to UTF-8, ignoring errors, and decodes it back to a clean string."""
...
def build_and_save_hierarchical_index():
    ...
    for url in URLS_TO_ADD:
        ...
        try:
            ...
            doc = Document(text=clean_main_content, metadata={"source_url": url, "document_type": "Web Page"})
